...
Route::middleware(['auth'])->group(function () {
   ...
   Route::get('/pendaftaranproposal', [PendaftaranProposalController::class, 'index'])->name('pendaftaranproposal');
    ...
    Route::middleware(['auth', 'role:admin'])->group(function () {
        ...
        Route::post('/pengajuanpembimbing/approve/{id}', [DashboardAdminController::class, 'approve'])->name('pengajuanpembimbing.approve');
        Route::post('/pengajuanpembimbing/reject/{id}', [DashboardAdminController::class, 'reject'])->name('pengajuanpembimbing.reject');
    });
