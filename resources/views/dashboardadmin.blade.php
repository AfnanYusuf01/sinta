        ...
        <div class="table-container">
          <table>
            ...
            <tbody>
                  ...
                  <div class="status-actions">
                    @if($pengajuan->status === 'menunggu')
                      ...
                      <div class="action-buttons-group">
                        <button class="action-btn approve-btn" onclick="handleAction('approve', {{ $pengajuan->id }}, this)">
                          <i class="fas fa-check"></i> Setujui
                        </button>
                        <button class="action-btn reject-btn" onclick="handleAction('reject', {{ $pengajuan->id }}, this)">
              ...
              @empty
              <tr>
                <td colspan="5" class="text-center">Belum ada pengajuan pembimbing</td>
              </tr>
              @endforelse
            </tbody>
          </table>
