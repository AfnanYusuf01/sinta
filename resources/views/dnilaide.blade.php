...
<body>
        ...
        <ul>
          <li>
            <a href="{{ url('/dashboardadmin') }}">
              ...
              <span>Rekaman Pengajuan Pembimbing</span>
            </a>
          </li>
          <li>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <i class="fas fa-eye eye-icon" onclick="showNilaiDe({{ $nilai->id }})"></i>
                </td>
              </tr>
              @endforeach
            </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <table class="modal-table">
            ...
            <tbody>
              ...
              <tr>
                <td>3</td>
                <td>Metodologi</td>
                <td><span id="nilai3">0</span></td>
              </tr>
              <tr>
                <td>4</td>
                <td>Tinjaun Pustaka</td>
                <td><span id="nilai4">0</span></td>
              </tr>
              <tr>
                <td>5</td>
                <td>Kontribusi Penelitian</td>
                <td><span id="nilai5">0</span></td>
              </tr>
              <tr>
                <td>6</td>
                <td>Teknis Penulisan</td>
                <td><span id="nilai6">0</span></td>
              </tr>
              <tr>
                <td>7</td>
                <td>Kelayakan Tim Peneliti</td>
                <td><span id="nilai7">0</span></td>
              </tr>
              <tr style="font-weight: bold; background-color: var(--gray-light);">
                <td colspan="2">Total Nilai</td>
                <td id="modalTotalScore">0</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div style="margin-top: 20px; padding: 16px; background-color: var(--primary-light); border-radius: 6px;">
          ...
          <p style="margin: 0;" id="modalNotes">Mahasiswa telah menunjukkan pemahaman yang baik terhadap materi penelitian, namun perlu memperhatikan aspek metodologi untuk meningkatkan kualitas penelitian.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    async function showNilaiDe(id) {
      try {
        const response = await fetch(`/nilai-de/${id}`);
