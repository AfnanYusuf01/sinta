...
@section('title', 'Nilai Presentasi Proposal TA')

@section('page_title', 'Nilai Presentasi Proposal TA')
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="table-container">
        <table class="modal-table">
          ...
          <tbody>
            ...
            <tr>
              <td>2</td>
              <td>Kualitas Slide Presentasi</td>
      ...
      <div style="margin-top: 20px; padding: 16px; background-color: var(--primary-light); border-radius: 6px;">
        ...
        <p style="margin: 0;">Mahasiswa telah menunjukkan kemampuan presentasi yang baik, namun perlu meningkatkan kemampuan dalam menjawab pertanyaan dan manajemen waktu.</p>
      </div>
    </div>
  </div>
</div>
...
@section('scripts')
  <script>
    async function showNilaiPresentasi(id) {
      try {
      const response = await fetch(`/admin/nilai-presentasi/${id}`);
      if (!response.ok) {
