...
<body>
        ...
        <ul>
          <li>
            <a href="{{ url('/dashboardadmin') }}">
              ...
              <span>Nilai Presentasi Proposal TA</span>
            </a>
          </li>
          <li>
    ...
    <main class="main-content">
      ...
      <div class="card">
        <div class="card-header">
          <h2>Nilai Presentasi Proposal TA</h2>
        ...
        <div class="table-container">
          <table>
            ...
            <tbody>
              @foreach($nilaiPresentasi as $nilai)
              <tr>
                ...
                <td>
                  <i class="fas fa-eye eye-icon" onclick="showNilaiPresentasi({{ $nilai->id }})"></i>
                </td>
              </tr>
              @endforeach
            </tbody>
  ...
  <div class="modal" id="scoreModal">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Detail Nilai Presentasi Proposal TA</h3>
      ...
      <div class="modal-body">
        ...
        <div class="table-container">
          <table class="modal-table">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Penyajian Materi</td>
                <td><input type="text" id="nilai_penyajian" readonly></td>
              </tr>
              <tr>
                <td>2</td>
                <td>Tingkat Penguasaan Materi</td>
                <td><input type="text" id="nilai_tingkat_penguasaan" readonly></td>
              </tr>
              <tr>
                <td>3</td>
                <td>Kualitas Jawaban</td>
                <td><input type="text" id="nilai_kualitas_jawaban" readonly></td>
              </tr>
              <tr>
                <td>4</td>
                <td>Sikap dan Prilaku</td>
                <td><input type="text" id="nilai_sikap" readonly></td>
              </tr>
              <tr style="font-weight: bold; background-color: var(--gray-light);">
                <td colspan="2">Total Nilai</td>
                <td><input type="text" id="modalTotalScore" readonly></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div style="margin-top: 20px; padding: 16px; background-color: var(--primary-light); border-radius: 6px;">
          ...
          <p style="margin: 0;" id="catatan">Mahasiswa telah menunjukkan kemampuan presentasi yang baik dengan penguasaan materi yang memadai, namun perlu meningkatkan kualitas jawaban saat sesi tanya jawab.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    async function showNilaiPresentasi(id) {
      try {
        const response = await fetch(`/nilai-presentasi/${id}`);
        ...
        // Update nilai-nilai
        document.getElementById('nilai_penyajian').value = data.nilai_penyajian;
        document.getElementById('nilai_tingkat_penguasaan').value = data.nilai_tingkat_penguasaan;
        document.getElementById('nilai_kualitas_jawaban').value = data.nilai_kualitas_jawaban;
        document.getElementById('nilai_sikap').value = data.nilai_sikap;
        document.getElementById('modalTotalScore').value = data.total_nilai;
